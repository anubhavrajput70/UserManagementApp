<%-- 
    Document   : user-form
    Created on : 17-Jan-2022, 5:41:26 pm
    Author     : ANUBHAV
--%>
...
<html>
    ...
    <body style="background: url(img/start_page.jpg);background-size: cover;background-attachment: fixed">
        <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #ff004f">
                    <div>
                        <a href="https://github.com/anubhavrajput70" class="navbar-brand"> User Management App </a>
                    </div>
